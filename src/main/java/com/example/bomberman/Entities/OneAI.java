...
public class OneAI extends Entity{
    ...
    public OneAI(Bomber bomber, GamePanel gamePanel, Bomb bomb){

        this.gamePanel = gamePanel;
        setDefaultValues();
        getBalloonImage();
        direction = "DOWN";
        _ai = new AIMedium(bomber, this , bomb);
        _bomber = bomber;
    ...
    public void getBalloonImage(){
        try{
            up1 = ImageIO.read(getClass().getResourceAsStream("/sprites/oneal_right1.png"));
            up2 = ImageIO.read(getClass().getResourceAsStream("/sprites/oneal_right2.png"));
            up3 = ImageIO.read(getClass().getResourceAsStream("/sprites/oneal_right3.png"));
            down1 = ImageIO.read(getClass().getResourceAsStream("/sprites/oneal_left1.png"));
            down2 = ImageIO.read(getClass().getResourceAsStream("/sprites/oneal_left2.png"));
            down3 = ImageIO.read(getClass().getResourceAsStream("/sprites/oneal_left3.png"));
            right1 = ImageIO.read(getClass().getResourceAsStream("/sprites/oneal_right1.png"));
            right2 = ImageIO.read(getClass().getResourceAsStream("/sprites/oneal_right2.png"));
            right3 = ImageIO.read(getClass().getResourceAsStream("/sprites/oneal_right3.png"));
            left1 = ImageIO.read(getClass().getResourceAsStream("/sprites/oneal_left1.png"));
            left2 = ImageIO.read(getClass().getResourceAsStream("/sprites/oneal_left2.png"));
            left3 = ImageIO.read(getClass().getResourceAsStream("/sprites/oneal_left3.png"));
        } catch (IOException e){
            e.printStackTrace();
        }
    ...
    public void update(Object object){
        if((_bomber.bomberX-this.bomberX)*(_bomber.bomberX-this.bomberX)
                + (_bomber.bomberY-this.bomberY)*(_bomber.bomberY-this.bomberY) <= 30000) {
            speed = 5;
